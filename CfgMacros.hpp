...
#define GRE_RU_0 "rhs_mag_rdg2_white","rhs_mag_rgd5","rhs_mag_rgd5"
...
#define DOT_US_556MG_0 "rhsusf_100Rnd_556x45_soft_pouch","rhsusf_100Rnd_556x45_soft_pouch","rhsusf_100Rnd_556x45_soft_pouch"

#define DOT_US_762DMR_0 "rhsusf_20Rnd_762x51_m118_special_Mag","rhsusf_20Rnd_762x51_m118_special_Mag","rhsusf_20Rnd_762x51_m118_special_Mag","rhsusf_20Rnd_762x51_m118_special_Mag","rhsusf_20Rnd_762x51_m118_special_Mag","rhsusf_20Rnd_762x51_m118_special_Mag"
...
#define DOT_RU_545MG_0 "rhs_45Rnd_545X39_AK","rhs_45Rnd_545X39_AK","rhs_45Rnd_545X39_AK","rhs_45Rnd_545X39_AK_Green","rhs_45Rnd_545X39_AK_Green"
#define DOT_RU_545MG_1 "rhs_45Rnd_545X39_AK","rhs_45Rnd_545X39_AK","rhs_45Rnd_545X39_AK","rhs_45Rnd_545X39_AK","rhs_45Rnd_545X39_AK"

#define DOT_RU_762DMR_0 "rhs_10Rnd_762x54mmR_7N1","rhs_10Rnd_762x54mmR_7N1","rhs_10Rnd_762x54mmR_7N1","rhs_10Rnd_762x54mmR_7N1","rhs_10Rnd_762x54mmR_7N1","rhs_10Rnd_762x54mmR_7N1"

#define DOT_RU_762HMG_0 "rhs_100Rnd_762x54mmR","rhs_100Rnd_762x54mmR"

// Dotation Milice
#define DOT_MIL_762LMG_0 "rhs_30Rnd_762x39mm", "rhs_30Rnd_762x39mm", "rhs_30Rnd_762x39mm", "30Rnd_762x39_Mag_Green_F", "30Rnd_762x39_Mag_Green_F", "30Rnd_762x39_Mag_Green_F"

#define DOT_MIL_545LMG_0 "rhs_30Rnd_545x39_AK", "rhs_30Rnd_545x39_AK", "rhs_30Rnd_545x39_AK", "rhs_30Rnd_545x39_AK_green", "rhs_30Rnd_545x39_AK_green", "rhs_30Rnd_545x39_AK_green"

#define DOT_MIL_762MG_0 "hlc_45Rnd_762x39_m_rpk", "hlc_45Rnd_762x39_m_rpk", "hlc_45Rnd_762x39_m_rpk", "hlc_45Rnd_762x39_t_rpk", "hlc_45Rnd_762x39_t_rpk", "hlc_45Rnd_762x39_t_rpk"
...
// Groups
#define GROUP2(CLASSNAME,DISPLAYNAME,FACTION,SIDE,UNIT0,RANK0,UNIT1,RANK1) \
		class CLASSNAME { \
			name = DISPLAYNAME; \
			faction = FACTION; \
			side = SIDE; \
...
#define GROUP3(CLASSNAME,DISPLAYNAME,FACTION,SIDE,UNIT0,RANK0,UNIT1,RANK1,UNIT2,RANK2) \
		class CLASSNAME { \
			name = DISPLAYNAME; \
			faction = FACTION; \
			side = SIDE; \
...
#define GROUP4(CLASSNAME,DISPLAYNAME,FACTION,SIDE,UNIT0,RANK0,UNIT1,RANK1,UNIT2,RANK2,UNIT3,RANK3) \
		class CLASSNAME { \
			name = DISPLAYNAME; \
			faction = FACTION; \
			side = SIDE; \
...
#define GROUP5(CLASSNAME,DISPLAYNAME,FACTION,SIDE,UNIT0,RANK0,UNIT1,RANK1,UNIT2,RANK2,UNIT3,RANK3,UNIT4,RANK4) \
		class CLASSNAME { \
			name = DISPLAYNAME; \
			faction = FACTION; \
			side = SIDE; \
...
#define GROUP6(CLASSNAME,DISPLAYNAME,FACTION,SIDE,UNIT0,RANK0,UNIT1,RANK1,UNIT2,RANK2,UNIT3,RANK3,UNIT4,RANK4,UNIT5,RANK5) \
		class CLASSNAME { \
			name = DISPLAYNAME; \
			faction = FACTION; \
			side = SIDE; \
...
#define GROUP7(CLASSNAME,DISPLAYNAME,FACTION,SIDE,UNIT0,RANK0,UNIT1,RANK1,UNIT2,RANK2,UNIT3,RANK3,UNIT4,RANK4,UNIT5,RANK5,UNIT6,RANK6) \
		class CLASSNAME { \
			name = DISPLAYNAME; \
			faction = FACTION; \
			side = SIDE; \
